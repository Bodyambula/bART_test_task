...
{
    private readonly InMemoryTicketRepository _ticketRepository;
    private readonly InMemoryNotificationRepository _notificationRepository;
    ...
    public async Task CreateTicket_CreatesThreeNotificationsInPending()
    {
        ...
        var notificationService = new NotificationService(_notificationRepository, _ticketRepository, senders);
        var controller = new TicketsController(_ticketRepository, _notificationRepository, notificationService);
        ...
        var notifications = await _notificationRepository.GetByTicketIdAsync(response.Id);
    ...
    public async Task Retry_IncrementsAttemptsAndStopsAfterThree()
    {
        ...
        var updated = (await _notificationRepository.GetByTicketIdAsync(ticket.Id)).First();
        ...
        // Call 2
        await notificationService.SendPendingOrFailedNotificationsAsync(ticket.Id);
        updated = (await _notificationRepository.GetByTicketIdAsync(ticket.Id)).First();
    ...
    public async Task Notify_IsIdempotent()
    {
        ...
        // First Notify call
        await notificationService.SendPendingOrFailedNotificationsAsync(ticket.Id);
        var firstResult = (await _notificationRepository.GetByTicketIdAsync(ticket.Id)).First();
        ...
        // Second Notify call
        await notificationService.SendPendingOrFailedNotificationsAsync(ticket.Id);
        var secondResult = (await _notificationRepository.GetByTicketIdAsync(ticket.Id)).First();
    ...
    public async Task SendFailure_StoresErrorMessageInLastError()
    {
        ...
        var notificationService = new NotificationService(_notificationRepository, _ticketRepository, new[] { failingSender });
